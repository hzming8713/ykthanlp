...
import com.ahaxt.hanlp.algorithm.EditDistance;
import com.ahaxt.hanlp.utility.Predefine;
import com.ahaxt.hanlp.utility.TextUtility;
import com.ahaxt.hanlp.HanLP;
import com.ahaxt.hanlp.dictionary.common.CommonSynonymDictionary;
import com.ahaxt.hanlp.dictionary.common.CommonSynonymDictionaryEx;
...
public class CoreSynonymDictionaryEx
{
    ...
    static
    {
        ...
        {
            Predefine.logger.severe("载入核心同义词词典失败");
