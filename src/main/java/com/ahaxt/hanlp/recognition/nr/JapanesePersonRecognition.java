 ...
 * </copyright>
 */
package com.ahaxt.hanlp.recognition.nr;

import com.ahaxt.hanlp.collection.trie.DoubleArrayTrie;
import com.ahaxt.hanlp.dictionary.CoreDictionary;
import com.ahaxt.hanlp.dictionary.nr.JapanesePersonDictionary;
import com.ahaxt.hanlp.dictionary.nr.NRConstant;
...
public class JapanesePersonRecognition
{
    ...
    public static void recognition(List<Vertex> segResult, WordNet wordNetOptimum, WordNet wordNetAll)
    {
        ...
        DoubleArrayTrie.LongestSearcher searcher = JapanesePersonDictionary.getSearcher(charArray);
        int activeLine = 1;
        int preOffset = 0;
        while (searcher.next())
        {
            Character label = (Character) searcher.value;
