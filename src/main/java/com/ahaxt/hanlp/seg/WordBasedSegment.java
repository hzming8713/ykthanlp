 ...
 * </copyright>
 */
package com.ahaxt.hanlp.seg;

import com.ahaxt.hanlp.algorithm.Viterbi;
import com.ahaxt.hanlp.collection.AhoCorasick.AhoCorasickDoubleArrayTrie;
import com.ahaxt.hanlp.collection.trie.DoubleArrayTrie;
import com.ahaxt.hanlp.dictionary.CoreDictionary;
import com.ahaxt.hanlp.dictionary.CoreDictionaryTransformMatrixDictionary;
import com.ahaxt.hanlp.dictionary.CustomDictionary;
import com.ahaxt.hanlp.dictionary.other.CharType;
import com.ahaxt.hanlp.seg.common.Graph;
import com.ahaxt.hanlp.seg.common.Vertex;
import com.ahaxt.hanlp.seg.common.WordNet;
import com.ahaxt.hanlp.utility.TextUtility;
import com.ahaxt.hanlp.seg.NShort.Path.AtomNode;
import com.ahaxt.hanlp.seg.common.Term;
import com.ahaxt.hanlp.corpus.tag.Nature;
    ...
    protected void generateWordNet(final WordNet wordNetStorage)
    {
        ...
        while (searcher.next()) {
            wordNetStorage.add(searcher.begin + 1,
                    new Vertex(new String(charArray, searcher.begin, searcher.length), (CoreDictionary.Attribute) searcher.value, searcher.index));
        }
        // 强制用户词典查询
